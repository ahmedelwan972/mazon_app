    ...
    return BlocConsumer<MazonCubit,MazonStates>(
      ...
      builder: (context,state){
        ...
        return ConditionalBuilder(
          condition: cubit.favoriteModel!= null && state is! GetFavLoadingState,
          fallback: (context)=>Center(child: CircularProgressIndicator()),
          builder: (context)=>ListView.separated(
            itemBuilder: (context, index) => buildProductItem(context,data: cubit.favoriteModel!.data!.data![index].product),
